...
<script src="http://127.0.0.1/ykj/Public/style/post.js"></script>
<title><?php echo ($art["title"]); ?></title>		<script type="text/javascript">
...
<div class="topbar">
    <div class="inner">
        ...
        <ul class="nav">
            <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if($current == $vo['id']): ?>class='current-menu-item'<?php endif; ?>  id="menu-item-180" ><a href="/ykj/index.php/Home/cate/index/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["catename"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
...
<div class="meta">
	<h1 class="meta-tit"><?php echo ($art["title"]); ?></h1>
	<p class="meta-info">类别：<?php echo ($cat["catename"]); ?> &nbsp;&nbsp; 发表日期：<?php echo (date("Y-m-d",$art["time"])); ?> &nbsp;&nbsp; </p>
</div>

<!-- 广告代码2 -->

<div class="entry">
	<p><img class="aligncenter size-full wp-image-42806" src="/ykj/<?php echo ($art["pic"]); ?>"  width="630" height="399"  /></p>

	<?php echo (htmlspecialchars_decode($art["content"])); ?>

</div>

<div>文章版权属于文章作者所有，转载请注明：<a rel="bookmark" title=" 该去北上广哭，还是回小城市笑 " href=" http://yispace.net/42805.html ">http://yispace.net/42805.html</a></div> 

<div style="margin:10px 0;">标签：<a href="http://yispace.net/tag/%e4%ba%ba%e7%94%9f%e6%84%9f%e6%82%9f" rel="tag">人生感悟</a>, <a href="http://yispace.net/tag/%e4%bb%b7%e5%80%bc%e8%a7%82" rel="tag">价值观</a>, <a href="http://yispace.net/tag/%e7%8e%b0%e5%ae%9e%e7%94%9f%e6%b4%bb" rel="tag">现实生活</a> &nbsp;&nbsp;&nbsp;&nbsp;标题：<a href="http://yispace.net/42805.html" title="该去北上广哭，还是回小城市笑">该去北上广哭，还是回小城市笑</a></div>

<div>

<?php if($pre): ?><strong>上一篇：</strong>
<a class="prev-post icon-right" href="/ykj/index.php/Home/Article/index/id/<?php echo ($pre["id"]); ?>">
<?php echo ($pre["title"]); ?></a>
<?php else: ?>
...
<?php if($nxt): ?><strong>下一篇：</strong>
<a class="next-post" href="/ykj/index.php/Home/Article/index/id/<?php echo ($nxt["id"]); ?>">
<?php echo ($nxt["title"]); ?></a>
<?php else: ?>
...
<script>document.write(unescape('%3Cdiv id="hm_t_61751"%3E%3C/div%3E%3Cscript charset="utf-8" src="http://crs.baidu.com/t.js?siteId=99c2c06a529fc4c8787deb597141fe76&planId=61751&async=0&referer=') + encodeURIComponent(document.referrer) + '&title=' + encodeURIComponent(document.title) + '&rnd=' + (+new Date) + unescape('"%3E%3C/script%3E'));</script>
    ...
    <div class="widget widget_categories">
        ...
        <ul>
            <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="cat-item cat-item-18"><a href="/ykj/index.php/Home/cate/index/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["catename"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
    </div>
    ...
    <ul class='xoxo blogroll'>
        <?php if(is_array($links)): $i = 0; $__LIST__ = $links;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($vo["url"]); ?>" rel="friend" target="_blank"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
</div>
</div></div>
