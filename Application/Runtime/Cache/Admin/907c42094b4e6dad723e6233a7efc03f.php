    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/ykj/index.php/Admin/Link/edit" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th>链接名称：</th>
                                <td><input class="common-text" name="title" size="50" value="<?php echo ($link["title"]); ?>" type="text"></td>
                            </tr>
                            <tr>
                                <th>链接地址：</th>
                            ...
                            <tr>
                                <th>链接描述：</th>
                                <td><input class="common-text" name="desc" size="50" value="<?php echo ($link["desc"]); ?>" type="text"></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
